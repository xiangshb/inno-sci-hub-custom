...
// Mock Scientific Insights
export const mockInsights: ScientificInsights[] = [
  {
    _id: 'insight_001',
...
// Mock Research Plans
export const mockResearchPlans: ResearchPlans[] = [
  {
    _id: 'plan_001',
...
// Mock Intelligent Agents
export const mockAgents: IntelligentAgents[] = [
  {
    _id: 'agent_001',
    _createdDate: new Date('2024-01-01'),
    _updatedDate: new Date('2024-01-15'),
...
export const mockTools: IntelligentTools[] = [
  {
    _id: 'tool_001',
    _createdDate: new Date('2024-01-01'),
    _updatedDate: new Date('2024-01-15'),
...
// Mock Knowledge Network Concepts
export const mockKnowledgeConcepts: KnowledgeNetworkConcepts[] = [
  {
    _id: 'concept_001',
    _createdDate: new Date('2024-01-01'),
    _updatedDate: new Date('2024-01-15'),
...
// Mock Visualization Analysis
export const mockVisualizations: VisualizationAnalysis[] = [
  {
    _id: 'viz_001',
    _createdDate: new Date('2024-01-01'),
    _updatedDate: new Date('2024-01-15'),
